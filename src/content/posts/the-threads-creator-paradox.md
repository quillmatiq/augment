...
atUri: "at://did:plc:xgvzy7ni6ig6ievcbls5jaxe/site.standard.document/3mgnqrekkms2m"
---
...
But there seems to be an existential question that keeps bubbling up under the surface every few weeks that finally came to a head on its first anniversary: [Why does Threads exist?](https://www.washingtonpost.com/technology/2024/07/05/meta-threads-creators-one-year)

The obvious reason is to be an alternative to Elon Musk's X. But considering its heavy-handed approach to the [kind of content](https://www.platformer.news/threads-175-million-users-adam-mosseri-interview/) Meta wants on the site, along with statements in early interviews, it's clear that they don't want to *beat* Twitter. Like Mastodon, Threads has very different ideas of what microblogging should be, which still leaves space for Twitter to exist for specific niches.
...
In Tech Threads, you have users like [Eleonor Rose](https://www.threads.net/@eleonor.rose), who flies city to city to attend meetups, open-sources her work, elevates users in the community who build interesting products, and set up a Discord server and multiple Instagram group chats. [Johnathan Garelick](https://www.threads.net/@jonathangarelick) also started a Seattle Tech Threads meetup series using Meetup. Those Discords, IG group chats, and meetups are where I'm actually discovering some of my closest friends on the platform.

In NBA Threads, creators like [David Rushing](https://www.threads.net/@yorush) and [Sara Montour Lewis](https://www.threads.net/@saramontourlewis) curate community posts, engage across replies to boost other users, and help drive conversations during games. There's also a hilarious rivalry between the two, interwoven across many Threads. That, among other recurring conversations, keeps everyone engaged while games aren't happening. NBA Threads also utilizes Discord as a way to have conversations off of the main feed. 
...
Knowing that NBA Threads and other sports-related communities are growing on the platform, Threads has [added scoreboards](https://techcrunch.com/2024/03/22/threads-live-scores-sports-games/) to the search experience for NBA and MLB games. This enables users to see a live feed of content alongside game stats. This is great! They found specific community needs and doubled down on them.
...
Their money flow also speaks the same language. They've started various influencer programs that push Instagram creators (read: "celebrity" creators) to post on Threads with [a promise of $5K if they get 10,000 views](https://www.socialmediatoday.com/news/meta-offers-5000-bonus-influencers-post-threads/714521/). They're going for big celebrities like Taylor Swift, who, quite frankly, doesn't care about the platform whatsoever.
...
2. Why do you think that photo and video creators who, as Deirdre Assenza would say, "[spam and scram](https://www.threads.net/@deirdre.assenza/post/C9IwUKESJm4/?xmt=AQGzAfAo-iq2gAEyJYe10b45hqW6XPMOkt3vTKQmhpj_cg)," will do well on a microblogging platform?
...
And Lists. [Definitely Lists](https://augment.ink/threads-on-mastodon/). 
